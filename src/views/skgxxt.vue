			...
			<div style="margin: 50px 30px 30px 30px">
				<el-form ref="form" :model="form" :rules="rules" label-width="200px">
						...
						<el-col :span="12">
							<el-form-item label="水域类型" prop="waters">
								<el-select v-model="form.waters" placeholder="请选择水域类型">
									<el-option v-for="dict in dict.type.water_type" :key="dict.value"
					...
					<el-row>
							...
							<el-form-item label="面积" prop="extent">
								<el-input v-model="form.extent" placeholder="请输入面积" class="input-with-select">
									<el-select style="width: 100px;" v-model="form.extentDanwei" slot="append"
										placeholder="请选择">
										<el-option v-for="dict in dict.type.area_unit" :key="dict.value"
						...
						<el-col :span="12">
							<el-form-item label="养殖物种类1" prop="breedingSpecies">
								<el-input v-model="form.breedingSpecies" placeholder="请输入养殖物种类1" />
							</el-form-item>
					...
					<el-row>
						<el-col :span="12">
							<el-form-item label="养殖物种类2" prop="fish">
								<el-select v-model="form.fish" placeholder="请输入养殖物种类2">
					...
					<el-row>
						<el-col :span="12">
							<el-form-item label="渔获物中鲢：鳙：其他比例" prop="annualOutputProportion">
								<el-input v-model="form.annualOutputProportion" placeholder="请输入渔获物中鲢：鳙：其他比例" />
							</el-form-item>
						</el-col>
						<el-col :span="12">
					...
					<el-row>
						<el-col :span="12">
							<el-form-item label="苗种中鲢：鳙：其他比例" prop="annualReleaseProportion">
								<el-input v-model="form.annualReleaseProportion" placeholder="请输入年投放量 鲢：鳙：其他比例" />
							</el-form-item>
						</el-col>
					</el-row>
				</el-form>
...
<script>
	...
	export default {
		...
		dicts: ['water_type', 'breed_type','fish_type', 'area_unit', 'annual_output_unit', 'sys_level'],
		data() {
			return {
				type: '',
				options: regionData,
				...
				rules: {
					...
					annualReleaseProportion: [{
						required: true,
						message: "苗种中鲢：鳙：其他比例不能为空",
						trigger: "blur"
					}],
				}
			}
