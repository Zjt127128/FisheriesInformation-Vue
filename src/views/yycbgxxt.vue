		...
		<div style="margin: 50px 30px 30px 30px">
			<el-form ref="form" :model="form" :rules="rules" label-width="200px">
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="作业水域" prop="jobArea">
							<el-input v-model="form.jobArea" placeholder="请输入作业水域" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="作业方式" prop="jobWay">
							<el-input v-model="form.jobWay" placeholder="请输入作业方式" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="船长：宽：深" prop="shipLength">
							<el-input v-model="form.shipLength" placeholder="请输入船长：宽：深" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="证件是否齐全" prop="certificates">
							<el-select v-model="form.certificates" placeholder="请选择证件是否齐全">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="附属设备是否齐全" prop="equipment">
							<el-select v-model="form.equipment" placeholder="请选择附属设备是否齐全">
								<el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label"
									:value="dict.value"></el-option>
							</el-select>
						</el-form-item>
