	...
	<div class="app-container bg">
		...
		<div style="margin: 50px 30px 30px 30px">
			<el-form ref="form" :model="form" :rules="rules" label-width="200px">
					...
					<el-col :span="12">
						<el-form-item label="身份类别：" prop="identityCategory">
							<el-select v-model="form.identityCategory" placeholder="请选择身份类别">
								<el-option v-for="dict in dict.type.sf_id_type" :key="dict.value" :label="dict.label"
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="标的物的基本信息" prop="baseInformation">
							<el-input v-model="form.baseInformation" placeholder="请输入标的物的基本信息" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="申请后台给予信息支持" prop="applyFor">
							<el-input v-model="form.applyFor" placeholder="请输入申请后台给予信息支持" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
		...
		data() {
			return {
				...
				rules: {
					...
					baseInformation: [{
						required: true,
						message: "标的物的基本信息不能为空",
						trigger: "blur"
					}],
					applyFor: [{
						required: true,
						message: "申请后台给予信息支持不能为空",
						trigger: "blur"
					}],
				}
			}
