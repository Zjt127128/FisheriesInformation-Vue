	...
	<div class="app-container bg">
		...
		<div style="margin: 50px 30px 30px 30px">
			<el-form ref="form" :model="form" :rules="rules" label-width="200px">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="拟推广、转让科技成果名称" prop="scienceName">
							<el-input v-model="form.scienceName" placeholder="请输入拟推广、转让科技成果名称" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="应用领域概述" prop="applicationFields">
							<el-input v-model="form.applicationFields" placeholder="请输入应用领域概述" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
