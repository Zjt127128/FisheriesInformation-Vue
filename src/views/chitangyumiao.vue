...
<script>
	...
	export default {
		...
		dicts: ['water_type3', 'area_unit', 'breed_type', 'annual_output_unit2', 'price_unit','sys_level'],
		data() {
			return {
				type: '',
				options: regionData,
