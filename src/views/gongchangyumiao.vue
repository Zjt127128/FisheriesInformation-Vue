						...
						<el-form-item label="水体规模" prop="extent">
							<el-input v-model="form.extent" placeholder="请输入水体规模" class="input-with-select">
								<el-select style="width: 100px;" v-model="form.extentDanwei" slot="append"
									placeholder="请选择">
									<el-option v-for="dict in dict.type.water_body_unit" :key="dict.value"
					...
					<el-col :span="12">
						<el-form-item label="年投放量" prop="annualRelease">
							<el-input v-model="form.annualRelease" placeholder="请输入年投放量">
								<el-select style="width: 100px;" v-model="form.annualReleaseDanwei" slot="append"
									placeholder="请选择">
									<el-option v-for="dict in dict.type.annual_output_unit2" :key="dict.value"
										:label="dict.label" :value="dict.value"></el-option>
								</el-select>
					...
					<el-col :span="12">
						<el-form-item label="苗种或成品销售价格" prop="seedlingPrice">
							<el-input v-model="form.seedlingPrice" placeholder="请输入苗种或成品销售价格">
								<el-select style="width: 100px;" v-model="form.seedlingPriceDanwei" slot="append"
									placeholder="请选择">
...
<script>
	...
	import {
		addGongchangyumiao
	} from "@/api/system/gongchangyumiao";
	export default {
		name: "skgxxt",
		components: {
			Foot,
		...
		data() {
			return {
				...
				form: {
					...
					annualReleaseDanwei: '1',
					seedlingPriceDanwei: '1'
				},
				// 表单校验
				rules: {
					waters: [{
					...
					breedingSpecies: [{
						required: true,
						message: "育苗、养殖种类1不能为空",
						trigger: "blur"
					}],
					fish: [{
						required: true,
						message: "育苗、养殖种类2不能为空",
						trigger: "blur"
					}],
					annualOutput: [{
						required: true,
