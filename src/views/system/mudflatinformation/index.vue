...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="informationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="滩涂面积" align="center" prop="mudflatArea"/>
...
import {
  ...
  addInformation,
  updateInformation
} from '@/api/system/mudflatinformation'
  ...
  methods: {
    ...
    handleUpdateToShow(row) {
      ...
      getInformation(id).then(response => {
        ...
        this.open = true
        this.title = '查看海底滩涂增养殖技术经济资源信息共享系统信息'
    ...
    handleUpdate(row) {
      ...
      getInformation(id).then(response => {
        this.form = response.data
        this.open = true
        this.title = '修改海底滩涂增养殖技术经济资源信息共享系统信息'
      })
    },
    /** 提交按钮 */
    submitForm() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除海底滩涂增养殖技术经济资源信息共享系统信息编号为"' + ids + '"的数据项？').then(function() {
